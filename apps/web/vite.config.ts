...
/**
 * Configures the Preact web application build and API development proxy.
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@game-trades-club/shared/constants': resolve(
        __dirname,
        '../../packages/shared/src/constants',
      ),
      '@game-trades-club/shared/validation': resolve(
        __dirname,
        '../../packages/shared/src/validation',
      ),
      '@game-trades-club/shared/formatters': resolve(
        __dirname,
